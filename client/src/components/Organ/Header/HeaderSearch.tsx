        ...
        <div className="h-full hidden relative bg-white">
				<div className="flex justify-between w-full px-8">
					<div className="pr-1/6">
                        <Link href="/"><a className="flex px-4"><Image src='/img/logo.svg' width="60px" height="60px"/></a></Link>
                    </div>
                    <div className="m-auto w-full px-4 py-2 relative flex bg-gray-light rounded-md">
                        <button className="bg-transparent border-0" style={{outline : 'none'}}><Image src='/img/search.svg' width="30px" height="30px"/></button>
                    ...
                    <div className="px-4 m-auto">
                        <Link href="/"><a className="flex justify-center items-center rounded-full p-4" ><Image src='/img/exit.svg' width="30px" height="30px"/></a></Link>   
                    </div>
				</div>
